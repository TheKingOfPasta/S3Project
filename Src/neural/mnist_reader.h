...
void img_ctod(int num_data, unsigned char data_image_char[][784], double data_image[][784])
{
    int i;
    int j;
...
void label_ctoi(int num_data, unsigned char data_label_char[][1], int data_label[])
{
    int i;
...
void load_mnist()
{
    read_chars(TRAIN_IMAGE, 60000, LEN_INFO_IMAGE, 784, train_image_char, info_image);
