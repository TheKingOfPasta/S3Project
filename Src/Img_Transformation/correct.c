...
Matrix* inv(Matrix* M)
{
    ...
    double** val = m->values;
    double MM = M->values[0][0] * M->values[1][1] * M->values[2][2] + M->values[0][1] * M->values[1][2] * M->values[2][0]
                + M->values[0][2] * M->values[2][1] * M->values[1][0] - M->values[0][2] * M->values[1][1] * M->values[2][0]
                - M->values[0][1] * M->values[1][0] * M->values[2][2] - M->values[0][0] * M->values[2][1] * M->values[1][2];

    val[0][0] = M->values[1][1] * M->values[2][2] - M->values[1][2] * M->values[2][1];
    val[0][1] = M->values[0][2] * M->values[2][1] - M->values[0][1] * M->values[2][2];
    val[0][2] = M->values[0][1] * M->values[1][2] - M->values[0][2] * M->values[1][1];
    val[1][0] = M->values[1][2] * M->values[2][0] - M->values[1][0] * M->values[2][2];
    val[1][1] = M->values[0][0] * M->values[2][2] - M->values[0][2] * M->values[2][0];
    val[1][2] = M->values[0][2] * M->values[1][0] - M->values[0][0] * M->values[1][2];
    val[2][0] = M->values[1][0] * M->values[2][1] - M->values[1][1] * M->values[2][0];
    val[2][1] = M->values[0][1] * M->values[2][0] - M->values[0][0] * M->values[2][1];
    val[2][2] = M->values[0][0] * M->values[1][1] - M->values[0][1] * M->values[1][0];
